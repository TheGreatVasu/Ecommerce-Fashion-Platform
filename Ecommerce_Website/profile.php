...
<head>
    ...
    <style>
        ...
        .profile-section, .profile-card, .order-card, .address-card, .wishlist-card, .stat-card, .profile-img, .profile-btn, .profile-info, .profile-form, .profile-form input, .profile-form textarea, .profile-form select {
        ...
        .profile-btn, .profile-form button {
            border-radius: 0 !important;
            background: #fff !important;
            color: #111 !important;
        ...
        .profile-btn.btn-primary, .profile-form button.btn-primary {
            background: #111 !important;
            color: #fff !important;
        }
        .profile-btn.btn-primary:hover, .profile-form button.btn-primary:hover {
            background: #fff !important;
            color: #111 !important;
            border: 2px solid #111 !important;
